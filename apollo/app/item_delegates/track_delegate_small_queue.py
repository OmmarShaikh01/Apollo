...
from apollo.database.models import QueueModel
...
class TrackDelegate_Small_Queue(CustomItemDelegate):
    ...
    def draw_widget(
        ...
        parent_model: QueueModel = index.model()
        current_index_id = parent_model.index(index.row(), 1).data()
        if (
            parent_model.CURRENT_FILE_ID is not None
            and parent_model.CURRENT_FILE_ID == current_index_id
        ):
    ...
    def get_widget(
        ...
        sizePolicy.setHeightForWidth(
            TrackDelegate_Small_Queue_Frame.sizePolicy().hasHeightForWidth()
        )
        ...
        TrackDelegate_Small_Queue_Cover_pixmap.setObjectName(
            "TrackDelegate_Small_Queue_Cover_pixmap"
        )
        ...
        TrackDelegate_Small_Queue_time_label.setObjectName("TrackDelegate_Small_Queue_time_label")
        ...
        TrackDelegate_Small_Queue_title_label.setObjectName("TrackDelegate_Small_Queue_title_label")
        ...
        TrackDelegate_Small_Queue_title_label.setAlignment(
        ...
        TrackDelegate_Small_Queue_artist_label.setObjectName(
            "TrackDelegate_Small_Queue_artist_label"
        )
        ...
        TrackDelegate_Small_Queue_artist_label.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter
        )
        ...
        TrackDelegate_Small_Queue_album_label.setObjectName("TrackDelegate_Small_Queue_album_label")
        ...
        TrackDelegate_Small_Queue_album_label.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter
        )
        ...
        TrackDelegate_Small_Queue_number_label.setObjectName(
            "TrackDelegate_Small_Queue_number_label"
        )
