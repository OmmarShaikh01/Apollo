...
class Stream(ABC):
    ...
    TAG_FRAMES = (
        ...
        'INITIALKEY', 'ORIGALBUM', 'ORIGFILENAME', 'ORIGARTIST', 'ORIGLYRICIST', 'FILEOWNER', 'NETRADIOSTATION',
        'NETRADIOOWNER', 'SETSUBTITLE', 'MOOD', 'PRODUCEDNOTICE', 'ENCODINGTIME', 'RELEASETIME', 'TAGGINGTIME',
        'ALBUMSORTORDER', 'PERFORMERSORTORDER', 'TITLESORTORDER', 'USERTEXT', 'WWWAUDIOFILE', 'WWWARTIST',
        'WWWAUDIOSOURCE', 'WWWCOMMERCIALINFO', 'WWWCOPYRIGHT', 'WWWPUBLISHER', 'WWWRADIOPAGE', 'WWWPAYMENT', 'WWWUSER',
        'INVOLVEDPEOPLE', 'MUSICIANCREDITLIST', 'INVOLVEDPEOPLE2', 'UNSYNCEDLYRICS', 'COMMENT', 'CDID', 'EVENTTIMING',
        'PICTURE', 'PLAYCOUNTER', 'POPULARIMETER', 'BITRATE', 'CHANNELS', 'SAMPLERATE', 'BITRATEMODE', 'TRACKGAIN',
        'TRACKPEAK', 'ALBUMGAIN')
    ...
    def _get_stream_info(self) -> dict:
        return dict(file_id = self._file_id(), file_path = str(self.path.as_posix()), file_name = self.path.name,
