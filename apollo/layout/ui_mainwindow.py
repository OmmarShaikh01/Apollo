...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.audio_fx_tab = QWidget()
        self.audio_fx_tab.setObjectName(u"audio_fx_tab")
        self.main_tab_widget.addTab(self.audio_fx_tab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.audio_fx_tab), QCoreApplication.translate("MainWindow", u"Audio FX", None))
        self.queue_groupbox.setTitle(QCoreApplication.translate("MainWindow", u"Currently Playing", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"OO", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"OO", None))
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"OO", None))
