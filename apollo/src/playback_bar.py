...
class PlayBackBar:
    QUEUE_POINTER_CHANGED = ApolloSignal()
    ...
    def setupUI(self):
        ...
        self.ui.audio_fx_pushbutton.clicked.connect(lambda: (self.ui.main_tab_widget.setCurrentIndex(3)))
    ...
    def connectQueueValueChange(self, callback: Callable = lambda x: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
        """
        self.model.TABLE_UPDATE.connect(lambda: self.updatePlayerQueue())

    def connectSeekingSliderValueChange(self, callback: Callable = lambda x: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectSeekingSliderValueReleased(self, callback: Callable = lambda x: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectVolumeSliderValueChange(self, callback: Callable = lambda x: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectVolumeSliderValueReleased(self, callback: Callable = lambda x: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectPlayPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectOffPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectRepeatPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectShufflePushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectEffectsSwitchPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectSettingsPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectNextTrackPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
    ...
    def connectPreviousTrackPushbutton(self, callback: Callable = lambda: None):
        """
        Connector Function for
        Args:
            callback: callable to call when event is triggered
